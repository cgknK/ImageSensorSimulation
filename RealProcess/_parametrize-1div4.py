...
def _manual_resize(image, target_width, target_height, iterations=1):
    """
    ...
    def process_image(image, iterations, target_width, target_height):
        ...
        for _ in range(iterations):
            ...
            current_image = create_new_image(new_data, target_width, target_height)

        return current_image

    resized_image = process_image(image, iterations, target_width, target_height)
    resized_image.save('_parametrize-1div4.jpg')

# Kullanım:
image = Image.open("0.jpg")
_manual_resize(image, 100, 100, iterations=2)
